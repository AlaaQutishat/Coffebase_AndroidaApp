package com.example.coffeeuser.ui.gallery;
...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                        ...
                        if (dataSnapshot1.child("deactivate").getValue().toString().equals("0")) {
                            if (dataSnapshot1.child("category").getValue().toString().equalsIgnoreCase("Hot Drink")) {
        ...
        OrderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String activity= getActivity().getIntent().getStringExtra("activity");
                if (activity!=null && activity.equalsIgnoreCase("Order")||activity!=null && activity.equalsIgnoreCase("favourite")){
                ...
                myRef.child("Users").child(AUTH.getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        move.putExtra("activity", "GalleryFragment");
    ...
    public void found(final String name) {
        ...
        final String cafename = result.getString("name", "datanotfound");
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        final DatabaseReference myRef2 = database.getReference().child("favourite").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(cafename);
        myRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                System.out.println(x[0] + "hi1");
                SharedPreferences flag = getActivity().getSharedPreferences("flag", Context.MODE_PRIVATE);
                SharedPreferences.Editor editee = flag.edit();
                editee.putInt("flag", x[0]);
                editee.apply();
            }
